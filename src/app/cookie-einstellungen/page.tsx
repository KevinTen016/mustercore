...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Cookie-Einstellungen der WebCore Website anpassen — notwendige und optionale Cookies.',
  path: '/cookie-einstellungen\page.tsx',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Hier können Sie Ihre Einwilligung jederzeit anpassen oder widerrufen.
        </p>
