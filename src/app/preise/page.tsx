...
export const metadata: Metadata = buildMetadata({
  title: 'Preise',
  description: 'Transparente Preise für WebCore BASIS, STANDARD und PREMIUM. Alle Beträge netto zzgl. 19 % USt.',
  path: '/preise\page.tsx',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Drei Pakete — für jeden Betrieb das Richtige. Alle Preise netto zzgl. 19 % USt.
        </p>
