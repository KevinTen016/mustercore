...
export const metadata: Metadata = buildMetadata({
  title: 'Referenzen',
  description: 'Referenzen und Kundenprojekte von WebCore. In Vorbereitung.',
  path: '/referenzen',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Unsere ersten Kundenprojekte sind in Vorbereitung. Sprechen Sie uns gerne direkt an.
        </p>
