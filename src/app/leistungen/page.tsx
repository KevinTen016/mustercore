...
export const metadata: Metadata = buildMetadata({
  title: 'Leistungen',
  description: 'Was WebCore bietet: Website, Online-Buchungssystem und Admin-Panel für lokale Unternehmen in Deutschland.',
  path: '/leistungen\page.tsx',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Website, Buchungssystem und Admin-Panel — aus einer Hand, DSGVO-konform.
        </p>
