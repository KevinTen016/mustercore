...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Website mit Kursbuchung für Fitness- und Yogastudios. Online-Buchung, Teilnehmerverwaltung.',
  path: '/branchen\fitness\page.tsx',
});
