...
export const metadata: Metadata = buildMetadata({
  title: 'Friseursalons',
  description: 'Website mit Online-Buchung für Friseursalons. DSGVO-konform, einfach zu bedienen, aus Braunschweig.',
  path: '/branchen\friseur\page.tsx',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Online-Buchung, die Ihre Stammkunden begeistert — und Neukunden überzeugt.
        </p>
