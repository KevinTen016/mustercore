...
export const metadata: Metadata = buildMetadata({
  title: 'Physiotherapiepraxen',
  description: 'Website mit Terminbuchung für Physiotherapeuten. DSGVO-konform, einfaches Admin-Panel.',
  path: '/branchen\physiotherapie\page.tsx',
});
