...
const DATA = BRANCHEN.find(b => b.slug === 'autowerkstatt')!;

export const metadata: Metadata = buildMetadata({
  title: 'MusterCore für Autowerkstätten',
  description:
    'Website mit Online-Buchung für Autowerkstätten und KFZ-Betriebe. Terminbuchung für Inspektionen, Reifenwechsel und mehr — aus Braunschweig.',
  path: '/branchen/autowerkstatt',
});

export default function AutowerkstattPage() {
  return (
      ...
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <div style={{ padding: '2rem', background: 'var(--bg-card)', border: '1px solid var(--line)', borderRadius: 'var(--radius-xl)', textAlign: 'center' }}>
          <p style={{ marginBottom: '1.25rem', color: 'var(--text)' }}>
            Weniger verpasste Anrufe, mehr gebuchte Werkstattplätze — in 20 Minuten Demo.
          </p>
          <Link href="/demo" className="btn btn-primary btn-lg">{DATA.cta}</Link>
        </div>
      </div>
