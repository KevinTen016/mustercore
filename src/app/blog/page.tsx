...
export const metadata: Metadata = buildMetadata({
  title: 'Ratgeber',
  description: 'Der WebCore Ratgeber: Tipps für lokale Unternehmen zu Online-Buchung, DSGVO und Google Business.',
  path: '/blog\page.tsx',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Praxisnahe Tipps für lokale Unternehmen — zu Online-Buchung, DSGVO und Google Business.
        </p>
