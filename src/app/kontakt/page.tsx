...
export const metadata: Metadata = buildMetadata({
  title: 'Kontakt',
  description: 'WebCore kontaktieren — per E-Mail, Telefon oder Kontaktformular. Wir antworten innerhalb eines Werktages.',
  path: '/kontakt\page.tsx',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Wir freuen uns auf Ihre Nachricht. Kein Autoresponder, kein Ticket-System.
        </p>
