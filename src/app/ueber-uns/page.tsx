...
export const metadata: Metadata = buildMetadata({
  title: 'Über uns',
  description: 'WebCore ist ein Einzelunternehmen aus Braunschweig. Wir bauen Websites mit Online-Buchung für lokale Unternehmen.',
  path: '/ueber-uns\page.tsx',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Ein Unternehmen aus Braunschweig — für lokale Betriebe in Deutschland.
        </p>
