...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'AGB der WebCore Website — Dienstleistungsvertrag, Laufzeit, Kündigung, Haftung.',
  path: '/agb\page.tsx',
});
    ...
    <div style={{ paddingBlock: 'clamp(4rem, 10vw, 7rem)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <p style={{ fontSize: '1.05rem', color: 'var(--text-dim)', lineHeight: 1.68, maxWidth: '62ch' }}>
          Stand: wird nach Gewerbeanmeldung durch Anwalt geprüft und veröffentlicht.
        </p>
