...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    tagline: 'Volle Kontrolle. Für Betriebe mit Anspruch.',
    price: 149,
    setupFee: 399,
    recommended: false,
    maxMeister: 'unbegrenzt',
    targetCustomer: 'Größerer Betrieb, mehrere Standorte oder hohes Buchungsvolumen.',
    support: 'Priorität-Support, Reaktion innerhalb 8 Wertstunden, Telefon in dringenden Fällen',
    features: [
      { text: 'Alles aus STANDARD', included: true },
      { text: 'SMS-Erinnerungen für Kunden (bis 100 SMS/Monat inklusive)', included: true },
      { text: 'Unbegrenzt Mitarbeiter im Admin-Panel', included: true },
      { text: 'Erweiterte Statistik (Mitarbeiter-Dynamik, Auslastung, No-Show-Rate, MoM)', included: true },
      { text: 'Bewertungsblock (Trustpilot oder Google)', included: true },
      { text: 'Gutschein-Seite', included: true },
      { text: 'Quartals-Review (30 Min.)', included: true },
    ],
  },
];
